<template>
  <div class="example">
    ...
    <ZhujianExample v-if="currentMenuId === 19" />
    <GongjiaoExample v-if="currentMenuId === 20" />
    <HuasheExample v-if="currentMenuId === 21" />
    <LunanExample v-if="currentMenuId === 22" />
    <ShimaoExample v-if="currentMenuId === 23" />
    <focusExample v-if="currentMenuId === 24" />
  </div>
</template>
...
// ----------------------------------------
import ZhujianExample from "./zhujian example.vue"; // 住建高大厦1
import GongjiaoExample from "./gongjiao example.vue"; // 公交站台
import HuasheExample from "./huashe example.vue"; // 华设西侧工地
import LunanExample from "./lunan example.vue"; // 路南侧工地
import ShimaoExample from "./shimao example.vue"; // 世贸君望墅
import focusExample from "./focus example.vue"; // 多模型展示
import { ref } from "vue";
const menu = ref();
const lang = ref();
menu.value = [
  ...
  { id: 19, name_CN: "住建高大厦1", name_EN: "Zhujian example" },
  { id: 20, name_CN: "公交站台", name_EN: "Gongjiao example" },
  { id: 21, name_CN: "华设西侧工地", name_EN: "Huashe example" },
  { id: 22, name_CN: "路南侧工地", name_EN: "Lunan example" },
  { id: 23, name_CN: "世贸君望墅", name_EN: "Shimao example" },
  { id: 24, name_CN: "多模型展示", name_EN: "Focus example" },
];
